...
class BlazeFaceDetector:
    ...
    def generateAnchorBoxes(self, typ):
        ...
        if typ == "front":
            ...
            anchors_options = AnchorsOptions(input_size_width=128, input_size_height=128, min_scale=0.1484375,
                                             max_scale=0.75
            ...
            # Options to generate anchors for SSD object detection models.
            anchors_options = AnchorsOptions(input_size_width=256, input_size_height=256, min_scale=0.15625,
                                             max_scale=0.75
                                             , anchor_offset_x=0.5, anchor_offset_y=0.5, num_layers=4
                                             , feature_map_width=[], feature_map_height=[]
    ...
    def inference(self, data):
        ...
        result = self.session.run(
            [self.output_details[0].name, self.output_details[1].name, self.output_details[2].name,
             self.output_details[3].name], {self.input_name: data})
